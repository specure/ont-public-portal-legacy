...
var RMBTControlServerCommunication = function RMBTControlServerCommunication(rmbtTestConfig, advInfo, testServerConfig) {
                ...
                success: function success(data) {
                    ...
                    if (!advInfo) {
                        ...
                        var advSpdOpts = { 
                            ...
                            advertised_speed_option_uid: advInfo.advertised_speed_option_uid, 
                            speed_down_kbps: advInfo.speed_down_kbps, 
                            speed_up_kbps: advInfo.speed_up_kbps 
                        }
                
                        $.ajax({
                            type: "POST",
                            url: _rmbtTestConfig.controlServerURL + "/advertisedSpeedOptions",
                            data: JSON.stringify(advSpdOpts),
